...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        ...
        <%@include file="/page/client/client_menu_zcfz_fx.jspf" %>
                                                                    ...
                                                                    <div class="contentDesc">
                                                                        <div class="propertyDesc">
                                                                            <div class="totalProperty"
                                                                                ...
                                                                                <label style="font-size: 20px">${data.zzc.sumMoney}万</label>
                                                                                <%
                                                                                    Map data = (Map) request.getAttribute("data");
                                                                                    Map zzc = MapUtils.getMap(data, "zzc");
                                                                                    Map fz = MapUtils.getMap(data, "fz");
                                                                                    Map qy = MapUtils.getMap(data, "qy");
                                                                                    String onRise = MapUtils.getString(zzc, "onRise");
                                                                                    String fz_onRise = MapUtils.getString(fz, "onRise");
                                                                                    String qy_onRise = MapUtils.getString(qy, "onRise");
                                                                                    String zzcHtml = "";
                                                                                    String fzHtml = "";
                                                                                    String qycHtml = "";
                                                                                    if (onRise.equals("-")) {
                                                                                        zzcHtml = "<label>同比<span style=\"color:green;font-size: 20px\">↓-%</span></label>";
                                                                                    } else if (Integer.parseInt(onRise)>0){
                                                                                        zzcHtml = "<label>同比<span style=\"color:red;font-size: 20px\">↑"+onRise+"%</span></label>";
                                                                                    }else {
                                                                                        zzcHtml = "<label>同比<span style=\"color:red;font-size: 20px\">↓"+onRise+"%</span></label>";
                                                                                    }
                                                                                    if (fz_onRise.equals("-")) {
                                                                                        fzHtml = "<label>同比<span style=\"color:green;font-size: 20px\">↓-%</span></label>";
                                                                                    } else if (Integer.parseInt(fz_onRise)>0){
                                                                                        fzHtml = "<label>同比<span style=\"color:red;font-size: 20px\">↑"+fz_onRise+"%</span></label>";
                                                                                    }else {
                                                                                        fzHtml = "<label>同比<span style=\"color:red;font-size: 20px\">↓"+fz_onRise+"%</span></label>";
                                                                                    }
                                                                                    if (qy_onRise.equals("-")) {
                                                                                        qycHtml = "<label>同比<span style=\"color:green;font-size: 20px\">↓-%</span></label>";
                                                                                    } else if (Integer.parseInt(qy_onRise)>0){
                                                                                        qycHtml = "<label>同比<span style=\"color:red;font-size: 20px\">↑"+qy_onRise+"%</span></label>";
                                                                                    }else {
                                                                                        qycHtml = "<label>同比<span style=\"color:red;font-size: 20px\">↓"+qy_onRise+"%</span></label>";
                                                                                    }
                                                                                %>
                                                                            ...
                                                                            <div class="totalProperty">
                                                                                <label style="font-size: 20px">负债总计</label>
                                                                                <label style="font-size: 20px">${data.fz.sumMoney}万</label>
                                                                                <%= fzHtml%>
                                                                            </div>
                                                                            <div class="totalProperty">
                                                                                <label style="font-size: 20px">所有者权益</label>
                                                                                <label style="font-size: 20px">${data.qy.sumMoney}万</label>
                                                                                <%= qycHtml%>
                                                                            </div>
                                                                        </div>
                                                                    </div>
