...
<html lang="en">
	<head>
		...
		<script src="${ctx}/static/js/codeLibr/layui/layui.js"></script>
		<script src="${ctx}/static/js/codeLibr/codeMapperIndex.js"></script>
										...
										<div class="widget-box">
											<div class="widget-body">
												<div class="widget-main padding-8">
													<div id="codeMapperListAndButtonList" class="tree">
