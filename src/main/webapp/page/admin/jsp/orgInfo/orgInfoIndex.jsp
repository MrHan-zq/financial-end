...
<html lang="en">
	<head>
		...
		<script src="${ctx}/static/js/orgInfo/orgInfoManageIndex.js"></script>
				...
				<form class="form-search">
					<div class="row">
						<div class="widget-main">
							<span class="">
								<label>公司名称:</label>
								<input id="orgName" type="text" placeholder="公司名称" class="input-sm" />
							</span>&nbsp
							<span class="">
								<label>法人:</label>
								<input id="legalerName" type="text" placeholder="法人" class="input-sm" />
							</span>&nbsp
							<span class="">
								<label>联系人电话:</label>
								<input id="resPersonTel" type="text" placeholder="联系人电话" class="input-sm" />
							</span>&nbsp
							<span class="">
								<label>是否上市:</label>
