...
<html lang="en">
	<head>
		...
		<script src="${ctx}/static/ace/assets/js/layui/layui.js"></script>
		<link rel="stylesheet" href="${ctx}/static/ace/assets/js/layui/css/layui.css">
		<script src="${ctx}/static/js/report/tReportResultIndex.js"></script>
		...
		<script src="${ctx}/static/ace/assets/js/jquery.easyui.min.js"></script>
										...
										<div class="widget-box">
											<div class="widget-body">
												<div class="widget-main padding-8">
													<div id="tReportResultListAndButtonList" class="tree">
